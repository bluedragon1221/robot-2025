...
public class AlignReef extends Command {
    ...
    private final static TrapezoidProfile.Constraints theta_constraints = new TrapezoidProfile.Constraints(8, 8);
    ...
    public AlignReef(CommandSwerveDrivetrain drivetrain, SwerveRequest.FieldCentric drive_request, Pose2d goal_pose) {
        // this feels like python...
        this.drive_request = drive_request;
